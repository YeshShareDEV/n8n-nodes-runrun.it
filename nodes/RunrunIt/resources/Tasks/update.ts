...
export const TaskUpdateDescription: INodeProperties[] = [
	...
	"autoupdatesystem": {
		...
		description: 'Raw JSON payload for updating a Task. When Send raw body is enabled this object will be sent as the request body.',
		displayOptions: { show: { operation: ['update'], resource: ['Tasks'] } },
	},
